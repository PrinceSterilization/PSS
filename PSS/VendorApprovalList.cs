...
namespace PSS
{
    public partial class VendorApprovalList : Form
    {
        public VendorApprovalList()
        {
            InitializeComponent();
        }

        private void VendorApprovalList_Load(object sender, EventArgs e)
        {
            Tables CrTables;
            ...
            string rpt = @"\\PSAPP01\IT Files\PTS\Crystal Reports\" + "VendorApprovalList.rpt";
            crDoc.Load(rpt);
            ...
            sqlcmd = new SqlCommand("spRptVendorApproval", sqlcnn);
