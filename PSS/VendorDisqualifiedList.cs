...
namespace PSS
{
    public partial class VendorDisqualifiedList : Form
    {
        public VendorDisqualifiedList()
        {
            InitializeComponent();
        }

        private void VendorDisqualifiedList_Load(object sender, EventArgs e)
        {
            Tables CrTables;
            ...
            string rpt = @"\\PSAPP01\IT Files\PTS\Crystal Reports\" + "VendorDisqualifiedList.rpt";
            crDoc.Load(rpt);
            ...
            sqlcmd = new SqlCommand("spRptVendorDisqualified", sqlcnn);
