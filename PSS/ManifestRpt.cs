...
namespace GIS
{
    public partial class ManifestRpt : Form
    {
        public ManifestRpt()
        {
            InitializeComponent();    
        ...
        private void ManifestRpt_Load(object sender, EventArgs e)
        {
            ...
            SqlDataReader sqldr;           
            string rpt = @"\\gblnj4\GIS\Reports\" + "ManifestExList.rpt";

            crDoc.Load(rpt);
            sqlcmd = new SqlCommand("spRptManifestExceptionList", sqlcnn);
