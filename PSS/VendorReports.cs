...
namespace PSS
{
    public partial class VendorReports : Form
    {
        ...
        private void VendorReports_Load(object sender, EventArgs e)
        {
            ...
            string rpt = @"\\PSAPP01\IT Files\PTS\Crystal Reports\" + "VendorQualification.rpt";
            ...
            sqlcmd = new SqlCommand("spVendorQualiForm", sqlcnn);
            sqlcmd.CommandType = CommandType.StoredProcedure;
            sqlcmd.Parameters.AddWithValue("@VID", nVID);
