...
namespace PSS
{
    public partial class PurchaseOrderItemsNotReceived : Form
    {
        public PurchaseOrderItemsNotReceived()
        {
            InitializeComponent();
        }

        private void PurchaseOrderItemsNotReceived_Load(object sender, EventArgs e)
        {
            ...
            string rpt = @"\\PSAPP01\IT Files\PTS\Crystal Reports\POItemsNotReceived.rpt";
            ...
            sqlcmd = new SqlCommand("spRptPOItemsNotReceived", sqlcnn);
